...
class CkCharset  : public CkObject
{
	...
	bool GetHtmlCharset2(const char *htmlData, unsigned long htmlDataLen, CkString &strCharset);
	bool ConvertHtml2(const char *htmlIn, unsigned long htmlInLen, CkByteData &htmlOut);
	bool WriteFile2(const char *filename, const char *data, unsigned long dataLen);
	bool ConvertFromUnicode2(const char *data, unsigned long dataLen, CkByteData &mbData);
	bool ConvertToUnicode2(const char *data, unsigned long dataLen, CkByteData &uniData);
	...
	bool ConvertHtml3(const unsigned char *htmlIn, unsigned long htmlInLen, CkByteData &htmlOut);
	bool GetHtmlCharset3(const unsigned char *htmlData, unsigned long htmlDataLen, CkString &strCharset);
	...
	bool ConvertFromUnicode3(const unsigned char *data, unsigned long dataLen, CkByteData &mbData);
	bool ConvertToUnicode3(const unsigned char *data, unsigned long dataLen, CkByteData &uniData);
