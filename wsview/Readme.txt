========================================================================
		ActiveX Control DLL : WSVIEW
========================================================================

ControlWizard has created this project for your WSVIEW ActiveX Control
...
that make up your WSVIEW ActiveX Control DLL.
...
WSViewCtl.h
	This file contains the declaration of the CWSViewCtrl C++ class.

WSViewCtl.cpp
	This file contains the implementation of the CWSViewCtrl C++ class.

WSViewPpg.h
	This file contains the declaration of the CWSViewPropPage C++ class.

WSViewPpg.cpp
	This file contains the implementation of the CWSViewPropPage C++ class.

WSViewCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CWSViewCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file WSView.rc.
